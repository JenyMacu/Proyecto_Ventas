...
public class Nueva_venta {
    ...
    public void filtro_panel() {
        ...
        ActionListener verificar = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                nombres = cd.filtro_vendedor(nombres_uso, nit_uso, correo_uso, genero_uso);
    ...
    private void crear() {
        ...
        ActionListener guardar = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ClientesDAO cd = new ClientesDAO();
                cd.crear_cliente(Integer.parseInt(t1.getText()), t2.getText(), Integer.parseInt(t3.getText()), t4.getText(), t5.getText());
